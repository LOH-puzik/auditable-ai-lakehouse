...
class MLflowConfig(BaseModel):
    ...
    experiment_name: str = "/Shared/swift_audit/isolation_forest"
    registered_model_name: str = "swift_audit_isolation_forest"
...
class Settings(BaseSettings):
    ...
    # Secret: must come from env (SWIFT_AUDIT_ANCHORING_PRIVATE_KEY)
